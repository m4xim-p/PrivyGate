...
|---|---|---|---|---|
| 1 | Качество идентификации и маскирования ПДН | 6 | 4.5 | Все 17 категорий покрыты; golden F1 0.935; главный риск — api recall 0.938 (FN=69) |
...
- [ ] Поднять api recall (FN=69: PERSON, PASSPORT, INN) — главный пробел.
...
| api | 342 | 0.954 | 0.938 | 0.946 | 0.970 | 69 | 34 |
| extended | 39 | 0.900 | 1.000 | 0.947 | 1.000 | 0 | 3 |
| variants | 62 | 0.972 | 0.958 | 0.965 | 0.972 | 1 | 0 |

Главный пробел — **api dataset FN=69** (PERSON, PASSPORT, INN). Целевые
...
api recall 0.938 означает ~6% пропусков; на живом демо со сложным текстом это
