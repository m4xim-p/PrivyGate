...
|---|---|---|---|---|
| 1 | Качество идентификации и маскирования ПДН | 6 | 4.5 | Все 17 категорий покрыты; golden F1 0.935; главный риск — api recall 0.935 (FN=75) |
| 2 | Корректность демаскирования | 3 | 3 | Boundary-safe demasking, round-trip 100%, только авторизованным системам |
| 3 | Точность отнесения к ПДН и устойчивость к вариациям | 4 | 3 | variants F1 0.965; ловушки (Пушкин, адрес банка) исправлены; FP на PHONE/ADDRESS |
...
- [ ] Поднять api recall (FN=75: PERSON, PASSPORT, INN) — главный пробел.
...
|---|---:|---:|---:|---:|---:|---:|---:|
| golden | 180 | 0.898 | 0.975 | 0.935 | 0.975 | 0 | 7 |
| api | 342 | 0.954 | 0.935 | 0.944 | 0.970 | 75 | 34 |
| extended | 39 | 0.900 | 1.000 | 0.947 | 1.000 | 0 | 3 |
| variants | 62 | 0.972 | 0.958 | 0.965 | 0.972 | 1 | 0 |

Главный пробел — **api dataset FN=75** (PERSON, PASSPORT, INN). Целевые
...
api recall 0.935 означает ~6.5% пропусков; на живом демо со сложным текстом это
