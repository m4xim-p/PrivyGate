...
но формат запроса, ответа и семантика корреляции сохраняются.
...
- нагрузочный прогон длится примерно 5 минут и начинается с разгона;
- средняя нагрузка — около 330 RPS, пики — до 1000 RPS;
